...
def verify_site(house, city: str = None, plot=PLOT, sbc=None, tolerance_ft=1e-6) -> dict:
...
def verify_interior(layout: dict, city: str = None, mode: str = "freeform", sbc=None, tolerance_ft=1e-6, interior_rules: dict = None) -> dict:
